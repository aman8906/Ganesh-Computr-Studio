...
const serviceImages = {
  ...
  "document-scanning":
    "https://www.e-arc.in/wp-content/uploads/2026/08/Bulk-Document-Scanning.jpg",
  "banner-poster-printing":
    "https://shreejigraphic.com/wp-content/uploads/2025/12/SG-Dec-_33-Printing-Press-Banner-Poster-Design-CDR-File.jpg",
  "cup-tshirt-printing":
    "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT3FynPveyfHbMfvRKfJCmlb6Sa3cz0Od9ZMfiJ0pE0DA&s=10",
  "passport-photo":
    "https://5.imimg.com/data5/SELLER/Default/2022/2/GO/AH/UP/5295475/8-passport-size-photos-500x500-standard-scale-2-00x-gigapixel-500x500.jpg",
  "photo-printing":
    "https://cdn.canvaschamp.in/static/images/landingpage/photoprints/need_more_reasons.jpg",
  "wedding-cards":
  ...
  "wedding-decoration":
    "https://thejarvi.com/wp-content/uploads/2023/02/shadi-gadi10w.jpg",
};
      ...
      <div className="container-page relative py-14">
        ...
        >
          ...
          <motion.p variants={heroItem} className="text-muted mt-2 text-lg">
            Printing, photography and card-design services — pick a product to
            see details and place a request.
          </motion.p>
        </motion.div>

    ...
    >
      ...
      >
        <div className="relative h-32 overflow-hidden">
          ...
          <span
            className={`absolute top-3 left-3 flex h-8 w-8 items-center justify-center rounded-lg ${accent}`}
          >
            <IconComponent className="h-4 w-4" />
          </span>
          <span
            className={`absolute top-3 right-3 text-[10px] font-semibold px-2 py-1 rounded-full ${accent}`}
          >
        ...
        <div className="p-6 flex flex-col flex-1">
          ...
          <span className="inline-flex items-center gap-1.5 text-coral-dark font-semibold text-sm mt-5 group-hover:gap-2.5 transition-all">
